...
type MonitorHost struct {
	gorm.Model
	AgentID         string    `gorm:"index:idx_m_host_agent_time,priority:1"`
...
type MonitorCPU struct {
	gorm.Model
	AgentID    string    `gorm:"index:idx_m_cpu_agent_time,priority:1"`
...
type MonitorMemory struct {
	gorm.Model
	AgentID    string    `gorm:"index:idx_m_memory_agent_time,priority:1"`
...
type MonitorDisk struct {
	gorm.Model
	AgentID     string    `gorm:"index:idx_m_disk_agent_time,priority:1"`
...
type MonitorNet struct {
	gorm.Model
	AgentID   string    `gorm:"index:idx_m_net_agent_time,priority:1"`
...
type MonitorDocker struct {
	gorm.Model
	AgentID       string    `gorm:"index:idx_m_docker_agent_time,priority:1"`
...
type MonitorContainer struct {
	gorm.Model
	AgentID     string    `gorm:"index:idx_m_container_agent_time,priority:1"`
...
type MonitorImage struct {
	gorm.Model
	AgentID   string    `gorm:"index:idx_m_image_agent_time,priority:1"`
...
type MonitorNetwork struct {
	gorm.Model
	AgentID   string    `gorm:"index:idx_m_network_agent_time,priority:1"`
